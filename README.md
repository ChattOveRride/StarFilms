...
- Agregar peliculas a seccion "Todas las peliculas" (películas del grupo en la sección de destacados, ninguna otra en cartelera)
- Agregar página de soporte (sin nada todavía)
- <del>Arreglar los iconos del footer</del>
- Modificar los links del footer(que lleven a la página y seccion correcta)
- Que la tabla de las side bars se oculte junto la descripción
